package riliuchik.lab7_collections.fileCollections.Lab7_1_taskA4;
...
//
//ОТВЕТ: В ArrayList быстрее, так как мы просто обращаемся к элементу,
//       а в LinkedList надо проходиться последовательно от начала списка до этого элемента.

public class Lab7_1_taskA4 {
