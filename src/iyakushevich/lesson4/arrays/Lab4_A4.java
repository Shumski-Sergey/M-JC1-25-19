    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) { //формируем двухмерный массив, все значения которого - нули
                ...
                for (int k = i; k < n-i; k++) { //перезаписываем массив единицами
                    array[i][k] = 1; //с начальной строки
                    array[n-i-1][k]=1; //с концечной строки
                }
                System.out.print(array[i][j]); //вывод i-ой строки массива
            }
